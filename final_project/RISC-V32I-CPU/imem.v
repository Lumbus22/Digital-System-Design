...
module imem(
	...
	// Program: Calculate first 8 Fibonacci numbers and store in memory
	// Expected Results:
	//   mem[0] = 0, mem[1] = 1, mem[2] = 1, mem[3] = 2
	//   mem[4] = 3, mem[5] = 5, mem[6] = 8, mem[7] = 13
	...
	memory[16] = 32'h fe41cae3; // blt  x3, x4, -12      | if counter < 8, loop back to memory[9]
	...
	// Initialize remaining memory to NOP (addi x0, x0, 0)
